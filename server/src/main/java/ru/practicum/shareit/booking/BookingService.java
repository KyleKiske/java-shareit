...
public class BookingService {
    ...
    public Booking addBooking(long userId, BookingDto bookingDto) {
        ...
        if (item.getOwner().getId().equals(booker.getId())) {
            throw new WrongOwnerException("Cannot book item from yourself");
        }
    ...
    public Booking changeBookingStatus(long userId, long bookingId, boolean approved) {
        ...
        if (booking.getBooker().getId() == userId) {
            throw new WrongOwnerException("Can not change status of a booking if you are a booker");
        }
        if (booking.getItem().getOwner().getId() != userId) {
            throw new WrongUserException("You don't have access to this booking");
        }
    ...
    public Booking getBookingInfo(long userId, long bookingId) {
        ...
        if ((booking.getBooker().getId() != (userId)) && (booking.getItem().getOwner().getId() != userId)) {
            throw new WrongOwnerException("You don't have access to this booking");
        }
        return booking;
    }
